...
def main():
    ...
    test_loader = DataLoader(dataset[split_idx["test"]], batch_size=args.batch_size, shuffle=False,
                             num_workers=args.num_workers)
    #This is the line that calls the model layer and applies it with the arguments from the command line
    ...
    #Prints out the information about each training Epoch
